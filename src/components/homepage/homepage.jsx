...
<div className="col" id="col">
        <img loading="lazy" className="gfe-responsive-image__img gfe-responsive-image__img--no-border" src="https://edu.google.com/assets/icons/pages/main/workspace-for-education/classroom/classroom-banner-2.svg" alt=""></img>
